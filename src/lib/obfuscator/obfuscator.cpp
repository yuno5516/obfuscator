...
namespace obfuscator {
    ...
    void Instance<Img>::obfuscate() {
        ...
        for (const auto& func : functions_) {
            ...
            /// \note We can't iterate through the insns/bbs and execute transforms
    ...
    void Instance<Img>::assemble() {
        ...
        for (auto& [func, _] : functions_) {
            /// \todo perhaps i should split this monstrosity into a separate functions
